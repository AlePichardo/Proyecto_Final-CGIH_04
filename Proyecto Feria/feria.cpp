...
void display(Shader shader,  Model doggo, Model piso)
{
	shader.use();
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Animacion", NULL, NULL);
    if (window == NULL)
    {
	...
	// Load models
	Model doggoModel = ((char *)"Models/doggo/doggo.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		display(modelShader, doggoModel, pisoModel);
